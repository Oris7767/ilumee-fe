...
export const generateMetadata = pageMetadata({
  ...
  title: { vi: 'Mentorship 1-1', en: '1-1 Mentorship', fr: 'Mentorat 1-1' },
  description: {
    vi: 'Đồng hành 1-1 dài hạn — 4 buổi coaching/tháng, async Telegram, monthly review. $350/tháng, cam kết 3 tháng.',
    en: 'Long-term 1-1 mentorship — 4 coaching sessions/month, async Telegram support, monthly review. $350/month, 3-month minimum.',
    fr: 'Mentorat 1-1 long terme — 4 séances/mois, support Telegram async, revue mensuelle. 350 $/mois, engagement 3 mois.',
  },
});
      ...
      <JsonLd
        data={[
          ...
          serviceLd({
            ...
            name: '1-1 Mentorship',
            description:
              '4 coaching sessions of 60 min each per month via Zoom, async support via Telegram/voice within 24h, monthly review against BodyGraph transit and Soul Plan dashboard. 3-month minimum commitment.',
            price: '350',
            currency: 'USD',
          }),
        ]}
